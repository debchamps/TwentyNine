 ...
 */
public class RandomComputerPlayerWithSomeIntelligence extends RandomComputerMLPlayer implements  UINotifier {
    ...
    public RandomComputerPlayerWithSomeIntelligence(String id, PlayerPosition pos) {
        super(id, pos);
    }
    @Override
    ...
    public TwentyNineCard nextMove() {
        ...
        */
        ...
        TwentyNineCard pickedCard = allowedCards.get(pickCardId);
        List<TwentyNineCard> suitJack = (List<TwentyNineCard>)CardHelper.filterBySuitAndNumbers(allowedCards, gameState.getCurrentRound().getRoundSuit(), Arrays.asList("J"));
        if(suitJack != null && !suitJack.isEmpty()) {
            pickedCard = suitJack.get(0);
        }
        ...
        TwentyNineMLFeature feature = mlFeatureExtractor.extractFeatures(gameState, this, team, pickedCard);
