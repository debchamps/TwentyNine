...
public class WekaPlayer2 extends RandomComputerMLPlayer {
    ...
    public TwentyNineCard nextMove() {
        ...
        for (TwentyNineCard allowedCard : allAllowedCards) {
            ...
            try {
                ...
                double score = WekaClassifier2.classify(featureOfCard.toArray());
    ...
    public WekaPlayer2(String id, PlayerPosition pos) {
        super(id, pos);
    }
